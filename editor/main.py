...
class MainWindow(MainWindowBase):
    ...
    def create_actions(self):
        ...
        self.lasso_action = QAction(self.get_icon('lasso', icons_path=self.local_icons_path), '&Lasso', self)
        self.lasso_action.set_data(ModalTool.LASSO)
        self.lasso_action.set_checkable(True)
        self.poly_lasso_action = QAction(self.get_icon('polygon', icons_path=self.local_icons_path), '&Polygonal Lasso', self)
        self.poly_lasso_action.set_data(ModalTool.POLYGONAL_LASSO)
        self.poly_lasso_action.set_checkable(True)
        ...
        self.tool_action_group.add_action(self.lasso_action)
        self.tool_action_group.add_action(self.poly_lasso_action)
    ...
    def create_tool_bar(self):
        ...
        tool_bar.add_action(self.lasso_action)
        tool_bar.add_action(self.poly_lasso_action)
